...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-[#B8860B]/20 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container md:flex h-16 items-center justify-between hidden">
        ...
        <div className="flex items-center gap-4">
          <DarkModeToggle />
          <Link href="/account">
            <Button variant="ghost" size="icon" className="hover:text-[#B8860B]">
              <User className="h-5 w-5" />
              <span className="sr-only">Account</span>
            </Button>
          </Link>
          <Link href="/cart">
            <Button variant="ghost" size="icon" className="relative hover:text-[#B8860B]">
      ...
      <div className="container flex items-center justify-between h-16 md:hidden">
        <Link href="/" className="flex items-center">
          <span className="text-2xl font-semibold tracking-tight text-[#B8860B]">Velora</span>
        </Link>
